...
project = u'CORE-V Verification User Documentation'
copyright = u'2020, 2021, 2025 OpenHW Group'
...
# Specify a specific parser for Markdown
source_parsers = {
...
htmlhelp_basename = 'CORE-V_Verification_User_Documentation'
